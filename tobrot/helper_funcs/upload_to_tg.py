    ...
    if os.path.isdir(local_file_name):
        ...
        if os.path.getsize(local_file_name) > TG_MAX_FILE_SIZE:
            ...
            i_m_s_g = await message.reply_text(
                "Telegram ushbu faylni yuklashni qo'llab-quvvatlamaydi.\n"
                f"Aniqlangan fayl hajmi: {d_f_s} 😡\n"
                "\n🤖 fayllarni bo'lishga harakat qilmoqda🌝🌝🌚"
            )
            ...
            await i_m_s_g.edit_text(
                ...
                f"<code>{ba_se_file_name}</code> Faylni {number_of_files}ga Ajratib Yuborilmoqda.\n"
                "Hozir Telegramga Yuklanmoqda..."
            )
...
async def upload_single_file(message, local_file_name, caption_str, from_user):
    ...
    try:
        message_for_progress_display = await message.reply_text(
            "Yuklab olish boshlandi {}".format(os.path.basename(local_file_name))
        )
        ...
        await message_for_progress_display.edit_text("**XATO**\n" + str(e))
    else:
